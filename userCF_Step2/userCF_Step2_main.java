...
public class userCF_Step2_main {

	private static String InputPath = "/userCF/Step1_Output/part-r-00000";
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
		...
		job.setJarByClass(userCF_Step2_main.class);
		job.setMapperClass(userCF_Step2_Mapper.class);
