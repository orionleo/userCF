...
public class userCF_Step5_main {

	private static String InputPath = "/userCF/Step4_Output/part-r-00000";
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
		...
		job.setJarByClass(userCF_Step5_main.class);
		job.setMapperClass(userCF_Step5_Mapper.class);
