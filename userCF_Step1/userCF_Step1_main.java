...
public class userCF_Step1_main {

	private static String InputPath = "/userCF/Input/userCF_CustomerActionList_TEST";
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
		...
		job.setJarByClass(userCF_Step1_main.class);
		job.setMapperClass(userCF_Step1_Mapper.class);
